...
def desasignar_usuario(grupo_id: int, user_id: int, db: Session = Depends(get_db),
                       current_admin: User = Depends(get_current_admin)):
    """Elimina la asignación de un usuario de un grupo. Solo Admin."""
